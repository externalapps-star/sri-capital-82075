          ...
          {focusAreas.map((area, index) => (
            ...
            >
              ...
              <div className="absolute inset-0">
                ...
                <div className="absolute inset-0 bg-gradient-to-b from-background/70 via-background/60 to-background/75 dark:from-background/65 dark:via-background/55 dark:to-background/70" />
              </div>
