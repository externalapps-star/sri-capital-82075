        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {portfolioCategories.map((category, index) => (
            ...
            >
              ...
              <h3 className="font-serif text-xl sm:text-2xl font-bold mb-4 sm:mb-6 relative z-10 text-white">
                {category.title}
              </h3>
